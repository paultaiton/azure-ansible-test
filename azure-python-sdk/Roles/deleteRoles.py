...
if __name__ == "__main__":
    ...
    # results = authorization_client.role_assignments.delete(scope=scope, role_assignment_name=role_assignment_name)
    results = authorization_client.role_assignments.delete_by_id(role_id=role_assignment_id)
